...
<html lang="vi">
    <head>
        ...
        <title>Thêm Dịch vụ | Dormitory Management</title>
        ...
        <style>
            ...
            .form-control:focus, .form-select:focus { border-color: #e67e22; box-shadow: 0 0 0 0.25rem rgba(230, 126, 34, 0.1); }
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="card shadow-lg">
                        <div class="card-header text-center">
                            ...
                            <p class="small opacity-75 mb-0">Wifi, gửi xe, giặt ủi...</p>
                        </div>
                            ...
                            <form action="ServiceController" method="post" class="row g-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Ví dụ: Wifi, Gửi xe" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description" class="form-control" rows="2" placeholder="Mô tả ngắn gọn..."></textarea>
                                </div>
