<%-- 
    Document   : footer
    Created on : Feb 24, 2026, 4:31:14 AM
    Author     : toanl
--%>
...
<style>
    ...
    .footer-brand i {
        color: #e67e22; /* Màu cam biểu trưng cho sự ấm cúng của tổ ấm */
    }
    .footer-link {
        color: #6c757d;
...
<footer class="main-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="mt-3">
    <a href="https://github.com/Kanabe1411" 
       target="_blank" 
    ...
    <a href="https://github.com/Kanabe1411?tab=repositories" 
       target="_blank" 
       rel="noopener noreferrer"
       class="btn btn-sm btn-outline-secondary">
        <i class="bi bi-bug"></i> Báo lỗi & Góp ý
    </a>
</div>
            </div>
        </div>
